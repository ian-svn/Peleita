...
import static io.github.some_example_name.Puerta.countTiempoEnEscotilla;
import static io.github.some_example_name.Puerta.entrando;
...
public class Luchador extends Individuo{
    ...
    public void paint(SpriteBatch batch) {
        ...
        if(vivo) {
            ...
            if(Puerta.entrando) {
                batch.setColor(new Color(rgb888(255, 248, 168)));
            }
    ...
    public void chocarse(){
        ...
        for(Bloque bloque : piso.buscarHab().getBloques()){
            ...
            Rectangle reactArr = new Rectangle(getX(),getY()+10, getANCHO(), getALTO()/2);
            Rectangle reactAba = new Rectangle(getX(),getY()-10, getANCHO(), getALTO()/2);
            Rectangle reactIzq = new Rectangle(getX()-10,getY(), getANCHO(), getALTO()/2);
            Rectangle reactDer = new Rectangle(getX()+10,getY(), getANCHO(), getALTO()/2);
