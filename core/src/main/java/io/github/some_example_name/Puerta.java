...
public class Puerta {
    ...
    public final static int countTiempoEnEscotilla = 50;
    public int countTiempoEnEscotillaAux = countTiempoEnEscotilla;
    ...
    public void paint(SpriteBatch batch){
        sprite.draw(batch);
        //batch.draw(spriteRect,x,y,130,50);
        colision();
    }
    ...
    public void colision() {
        ...
        if (getBounds().overlaps(luchador.getBoundsPuertas())) {
            ...
            entrando = false;
            if(countTiempoEnEscotillaAux < countTiempoEnEscotilla){
                countTiempoEnEscotillaAux++;
            }
        } else {
            entrando = false;
        ...
        //System.out.println("countA" + countTiempoEnEscotillaAux);
    }
