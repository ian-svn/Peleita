...
public class Demonio extends Enemigo {
    ...
    public Demonio(Float x, Float y, Luchador luchador, Piso piso){
        ...
        atlas = new TextureAtlas("Enemigos/Demonio.atlas");
        setX(x);
        setY(y);
        setANCHO(80F);
        setALTO(90F);
    ...
    public void inicializarFrames(){
        frames.add(atlas.findRegion("Demonio1"));
        frames.add(atlas.findRegion("Demonio2"));
        frames.add(atlas.findRegion("Demonio3"));
    }
